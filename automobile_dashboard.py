...
#Include style for title
    ...
    html.Div(id='output-container', className='output-container', style={'marginTop': 30}),])
])
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Yearly Average Automobile Sales Over Time'))
